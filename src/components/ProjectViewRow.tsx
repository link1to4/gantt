...
import { Plus, Trash2, Edit2, Check, FolderKanban, ChevronDown, ChevronRight, Calendar } from 'lucide-react';
...
import { assignTracksToTasks, calculateTaskHours } from '../utils/time';
        ...
        <div className="divide-y divide-slate-800/60">
          {days.map((day) => {
            ...
            const handleRowGridClick = (e: React.MouseEvent<HTMLDivElement>) => {
              ...
              const halfSteps = Math.floor(clickX / halfHourWidth);
