      ...
      >
        ...
        <div className="p-6 space-y-4 text-xs sm:text-sm text-slate-600">
          <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 border border-slate-200">
            <Move className="w-5 h-5 text-indigo-600 flex-shrink-0 mt-0.5" />
            <div>
              <div className="font-semibold text-slate-900">移動項目時間位置</div>
          ...
          <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 border border-slate-200">
            <ArrowLeftRight className="w-5 h-5 text-sky-600 flex-shrink-0 mt-0.5" />
            <div>
              <div className="font-semibold text-slate-900">拉伸調整時間長度</div>
              <div className="text-xs text-slate-600 mt-0.5">
          ...
          <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 border border-slate-200">
            ...
            <div>
              <div className="font-semibold text-slate-900">X 軸連續多日延伸 (Day 1 ➔ Day 2 ➔ Day 3...)</div>
              <div className="text-xs text-slate-600 mt-0.5">
          ...
          <div className="flex items-start gap-3 p-3 rounded-xl bg-slate-50 border border-slate-200">
            <Edit3 className="w-5 h-5 text-purple-600 flex-shrink-0 mt-0.5" />
            <div>
              <div className="font-semibold text-slate-900">快速重命名與詳細編輯</div>
              <div className="text-xs text-slate-600 mt-0.5">
        ...
        <div className="px-6 py-3 bg-slate-50 border-t border-slate-200 flex justify-end">
          <button
            onClick={onClose}
            className="px-4 py-1.5 rounded-lg text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-700 transition shadow-xs"
          >
            知道了
          </button>
        </div>
